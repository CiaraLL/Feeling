...
import com.li.feeling.userdeatil.tab.feellist.UserDetailFeelListFragment;

/**
 * description: 用户详情页面--feel点赞列表
 */
public class UserDetailLikeFeelListFragment extends UserDetailFeelListFragment {
